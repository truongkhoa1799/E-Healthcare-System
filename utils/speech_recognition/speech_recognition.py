...
class Microphone(AudioSource):
    ...
    def __init__(self, device_index=None, sample_rate=None, chunk_size=1024):
        ...
        # print("SAMPLE_WIDTH: {}".format(self.SAMPLE_WIDTH))
        # print("SAMPLE_RATE: {}".format(self.SAMPLE_RATE))
...
class Recognizer(AudioSource):
    ...
    def recognize_google(self, audio_data, key=None, language=None, pfilter=0, show_all=False):
        """
